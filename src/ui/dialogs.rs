...
fn render_entry_dialog(f: &mut Frame, app: &App, title: &str, description: &str) {
    ...
    let key_block = Block::default()
        .title(" Key ")
        .borders(Borders::ALL)
        .style(Style::default().bg(Color::DarkGray).fg(
            if key_focused { Color::Yellow } else { Color::White }
        ));
    ...
    let key_content = if key_focused {
        ...
        vec![Span::styled(&app.dialog_key, Style::default().bg(Color::DarkGray).fg(Color::White))]
    };
    let key_paragraph = Paragraph::new(Line::from(key_content))
        .style(Style::default().bg(Color::DarkGray));
    ...
    let value_block = Block::default()
        ...
        .borders(Borders::ALL)
        .style(Style::default().bg(Color::DarkGray).fg(
            if value_focused { Color::Yellow } else { Color::White }
        ));
    ...
    let value_content = if value_focused {
        ...
        vec![Span::styled(&app.dialog_value, Style::default().bg(Color::DarkGray).fg(Color::White))]
    };
...
pub fn render_delete_dialog(f: &mut Frame, app: &App) {
    ...
    let content = vec![
        Line::from(""),
        Line::from(vec![
            Span::styled("Are you sure you want to delete:", Style::default().bg(Color::Red).fg(Color::White)),
        ]),
        Line::from(""),
        Line::from(vec![
            Span::styled(&key, Style::default().bg(Color::Red).fg(Color::Yellow)),
        ]),
        Line::from(""),
        Line::from(vec![
            Span::styled("Y/Enter: Yes    N/Esc: No", Style::default().bg(Color::Red).fg(Color::White)),
        ]),
    ];
